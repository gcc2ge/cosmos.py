...
from cosmos_sdk.core import Coins, Dec
from cosmos_sdk.core.deposit import Deposit
from cosmos_sdk.core.gov import Proposal, ProposalStatus, WeightedVoteOption
from cosmos_sdk.core.gov.data import Vote
